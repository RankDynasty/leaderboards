...
export const mockMembers: Member[] = [
  ...
  },
  {
    ...
    codmProfile: {
      ...
      favoriteMode: "Kill Confirmed",
      profilePicture: "/profiles/rachel.jpg",
      codmAvatar: "/codm-avatars/storm-trooper.jpg",
      loadouts: [
        {
          id: "l7",
          name: "Balanced AR",
          primaryWeapon: "HVK-30",
          secondaryWeapon: "MW11",
          perks: ["Fast Recover", "Ghost", "Alert"],
          scorestreaks: ["UAV", "Hunter Killer", "Lightning Strike"],
        },
      ],
      achievements: ["Tactical Expert", "Balanced Fighter", "Storm Caller"],
  ...
  },
  {
    ...
    codmProfile: {
      ...
      currentSeason: 11,
      clan: "Lone Wolves",
      favoriteWeapon: "ICR-1",
      favoriteMode: "Frontline",
      profilePicture: "/profiles/james.jpg",
      codmAvatar: "/codm-avatars/wolf-hunter.jpg",
      loadouts: [
        {
          id: "l8",
          ...
          primaryWeapon: "ICR-1",
          secondaryWeapon: "J358",
          perks: ["Tactical Mask", "Toughness", "Dead Silence"],
          scorestreaks: ["UAV", "Care Package", "Predator Missile"],
        },
      ],
      achievements: ["Lone Wolf", "Precision Master", "Steady Aim"],
  ...
  },
  {
    ...
    codmProfile: {
      ...
      clan: "Shadow Ninjas",
      favoriteWeapon: "MSMC",
      favoriteMode: "Gun Game",
      profilePicture: "/profiles/maya.jpg",
      codmAvatar: "/codm-avatars/ninja-assassin.jpg",
      loadouts: [
        {
          id: "l9",
          name: "Stealth SMG",
      ...
      achievements: ["Stealth Master", "Quick Draw", "Shadow Walker"],
  ...
  },
  {
    ...
    codmProfile: {
      ...
      clan: "Blaze Squad",
      favoriteWeapon: "BK57",
      favoriteMode: "Ranked MP",
      profilePicture: "/profiles/chris.jpg",
      codmAvatar: "/codm-avatars/blaze-fighter.jpg",
      loadouts: [
        {
          id: "l10",
          name: "Ranked Build",
          primaryWeapon: "BK57",
          secondaryWeapon: "MW11",
          perks: ["Fast Recover", "Hardwired", "Alert"],
          scorestreaks: ["UAV", "Care Package", "Lightning Strike"],
        },
      ],
      achievements: ["Rising Star", "Ranked Warrior", "Fire Fighter"],
  ...
  },
  {
    ...
    codmProfile: {
      ...
      clan: "Frost Legion",
      favoriteWeapon: "LK24",
      favoriteMode: "Capture the Flag",
      profilePicture: "/profiles/sophie.jpg",
      codmAvatar: "/codm-avatars/frost-mage.jpg",
      loadouts: [
        {
          id: "l11",
          name: "Support AR",
          primaryWeapon: "LK24",
          secondaryWeapon: "MW11",
          perks: ["Flak Jacket", "Ghost", "Engineer"],
          scorestreaks: ["UAV", "Counter UAV", "Care Package"],
        },
      ],
      achievements: ["Team Support", "Objective Player", "Ice Queen"],
      lastActive: "2024-01-15T05:55:00Z",
    },
  },
];
