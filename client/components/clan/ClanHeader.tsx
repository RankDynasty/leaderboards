        ...
        <div className="container mx-auto px-4 py-12 relative">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl mb-8 opacity-80 max-w-2xl mx-auto">
              Élite de Call of Duty Mobile Madagascar - Excellence, Stratégie,
              Victoire
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge
                variant="secondary"
                className="bg-primary-foreground/20 text-primary-foreground border-primary-foreground/30 text-base px-4 py-2"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Dominer les tournois CODM et représenter Madagascar avec
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Esprit d'équipe, excellence technique, fair-play et
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Championnats régionaux, qualification mondiale et formation de
